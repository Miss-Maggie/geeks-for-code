...
const HeroSection = () => (
  <header className="w-full py-16 flex flex-col items-center relative animate-fade-in">
    ...
    <a
      href="#contact"
      className="px-8 py-3 rounded-lg font-medium bg-primary text-primary-foreground text-lg shadow-lg story-link hover-scale transition-all focus:ring-2 focus:ring-offset-2 focus:ring-primary"
