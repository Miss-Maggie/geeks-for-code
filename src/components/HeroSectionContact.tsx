  ...
  <header className="w-full py-12 sm:py-16 flex flex-col items-center relative animate-fade-in px-4 sm:px-0">
    ...
    <div className="flex flex-wrap justify-center gap-6 mb-10">
      ...
      <a
        ...
        aria-label="Contact"
      >
        <div className="w-40 h-20 sm:w-40 sm:h-24 flex items-center justify-center rounded-full border border-primary text-primary dark:text-white hover:bg-primary hover:text-white transition">
          <Phone size={28} />
        </div>
